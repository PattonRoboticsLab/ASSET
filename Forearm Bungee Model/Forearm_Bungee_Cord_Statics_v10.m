...
videofile = fullfile([pwd '\MATLAB Figures'], 'ExoNET_Bungee_Wrapping_v10_Movie.mp4'); % file save path
...
saveas(figure(1), fullfile([pwd '\MATLAB Figures'],'ExoNET_Bungee_Wrapping_v10_Torque.png')); % save to computer
...
saveas(figure(2), fullfile([pwd '\MATLAB Figures'],'ExoNET_Bungee_Wrapping_v10_Supplemental.png')); % save to computer
