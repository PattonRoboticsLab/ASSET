...
videofile = fullfile([pwd '\MATLAB Figures'], 'ExoNET_Hybrid_v1_Movie.mp4'); % file save path
...
saveas(figure(1), fullfile([pwd '\MATLAB Figures'],'ExoNET_Hybrid_v1_Torque.png')); % save to computer
...
saveas(figure(2), fullfile([pwd '\MATLAB Figures'],'ExoNET_Hybrid_v1_Supplemental.png')); % save to computer
...
P.up_arm_rod_mom_arm = double(separateUnits(unitConvert(P.up_arm_rod_mom_arm*u.in,u.m)))/2; % convert to meters and halve it
P.wrist_rod_mom_arm = double(separateUnits(unitConvert(P.wrist_rod_mom_arm*u.in,u.m)))/2; % convert to meters and halve it
P.wrist_bungee_mom_arm = double(separateUnits(unitConvert(P.wrist_bungee_mom_arm*u.in,u.m)))/2; % convert to meters and halve it
P.forearm_bungee_mom_arm = double(separateUnits(unitConvert(P.forearm_bungee_mom_arm*u.in,u.m)))/2; % convert to meters and halve it
...
% Initialize angles
P.theta_wrist_mom_arm = deg2rad(P.init_wrist_rod_angle); % initial wrist rod angle in radians
P.theta_forearm_mom_arm = deg2rad(P.init_forearm_rod_angle); % initial forearm angle in radians
P.theta_up_arm_mom_arm = deg2rad(P.theta_up_arm_mom_arm); % initial upper arm moment arm angle in radians
...
for i = 1:P.total_frames % iterate through each frame
    ...
    S.tau = S.tau_rod + S.tau_bungee; % sum the rod and bungee torques
